...
6.  **Set up Communication Channel:**
    ...
    -   **Telegram:**
        ...
        -   **Whitelist Configuration:** Set `TELEGRAM_ALLOWED_USERS` in your `.env` file to a comma-separated list of allowed usernames (e.g., `username1,username2`). Leave empty to allow **all** users.
    -   **Slack:**
